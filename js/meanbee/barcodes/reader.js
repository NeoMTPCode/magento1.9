...
(function () {
    document.addEventListener('DOMContentLoaded', function () {
        ...
        barcodeImage.src = location.protocol + '//' + location.host + '/skin/adminhtml/default/default/images/meanbee/barcodes/barcode.png';
        ...
        barcodeSearchButton.addEventListener('click', function () {
            ...
            Quagga.onDetected(function (result) {
                ...
                if(tmp.toString().length == 13){
                    tmp = result.codeResult.code.toString().slice(0,-1).slice(3);
                }
                searchBox.value = tmp;
